  ...
  return (
    ...
    >
      <g id="logout">
        <path
          clipRule="evenodd"
          d="M2.75 4.58333C2.75 3.575 3.575 2.75 4.58333 2.75H11.9167V4.58333H4.58333V17.4167H11.9167V19.25H4.58333C3.575 19.25 2.75 18.425 2.75 17.4167V4.58333ZM15.7447 10.0833L13.42 7.75867L14.7162 6.4625L19.2537 11L14.7162 15.5375L13.42 14.2413L15.7447 11.9167H9.7075V10.0833H15.7447Z"
          fill="currentColor"
          fillRule="evenodd"
        />
      </g>
  ...
  return (
    ...
    >
      <g>
        ...
        />
        <path
          d="M11 15.125C10.1842 15.125 9.38663 14.8831 8.70827 14.4298C8.02992 13.9766 7.50121 13.3323 7.189 12.5786C6.87679 11.8248 6.7951 10.9954 6.95426 10.1953C7.11343 9.39508 7.50629 8.66008 8.08318 8.08318C8.66008 7.50629 9.39508 7.11343 10.1953 6.95426C10.9954 6.7951 11.8248 6.87679 12.5786 7.189C13.3323 7.50121 13.9766 8.02992 14.4298 8.70827C14.8831 9.38663 15.125 10.1842 15.125 11C15.1305 11.5432 15.0276 12.0821 14.8222 12.5851C14.6169 13.088 14.3133 13.545 13.9291 13.9291C13.545 14.3133 13.088 14.6169 12.5851 14.8222C12.0821 15.0276 11.5432 15.1305 11 15.125ZM11 8.25C10.6365 8.24153 10.2752 8.30688 9.93769 8.44208C9.60021 8.57728 9.29367 8.77954 9.0366 9.0366C8.77954 9.29367 8.57728 9.60021 8.44208 9.93769C8.30688 10.2752 8.24153 10.6365 8.25 11C8.24153 11.3635 8.30688 11.7248 8.44208 12.0623C8.57728 12.3998 8.77954 12.7063 9.0366 12.9634C9.29367 13.2205 9.60021 13.4227 9.93769 13.5579C10.2752 13.6931 10.6365 13.7585 11 13.75C11.3635 13.7585 11.7248 13.6931 12.0623 13.5579C12.3998 13.4227 12.7063 13.2205 12.9634 12.9634C13.2205 12.7063 13.4227 12.3998 13.5579 12.0623C13.6931 11.7248 13.7585 11.3635 13.75 11C13.7585 10.6365 13.6931 10.2752 13.5579 9.93769C13.4227 9.60021 13.2205 9.29367 12.9634 9.0366C12.7063 8.77954 12.3998 8.57728 12.0623 8.44208C11.7248 8.30688 11.3635 8.24153 11 8.25Z"
          fill="currentColor"
        />
      </g>
    </svg>
  ...
  return (
    ...
    >
      <g>
        ...
        />
        <path
          d="M11.6875 3.73683C11.9496 3.5754 12.1545 3.32622 12.2703 3.02793C12.3862 2.72965 12.4065 2.39893 12.3281 2.08706C12.2498 1.7752 12.0772 1.49963 11.837 1.30308C11.5969 1.10653 11.3027 1 11 1C10.6973 1 10.4031 1.10653 10.163 1.30308C9.92282 1.49963 9.75019 1.7752 9.67185 2.08706C9.59351 2.39893 9.61383 2.72965 9.72967 3.02793C9.8455 3.32622 10.0504 3.5754 10.3125 3.73683V5.40003H7.5625C5.92147 5.40003 4.34766 6.09538 3.18728 7.33312C2.0269 8.57086 1.375 10.2496 1.375 12V12.7334C1.01033 12.7334 0.660591 12.8879 0.402728 13.1629C0.144866 13.438 0 13.811 0 14.2L0 17.1333C0 17.5223 0.144866 17.8954 0.402728 18.1704C0.660591 18.4455 1.01033 18.6 1.375 18.6V20.0667C1.375 20.8446 1.66473 21.5907 2.18046 22.1408C2.69618 22.691 3.39565 23 4.125 23H17.875C18.6043 23 19.3038 22.691 19.8195 22.1408C20.3353 21.5907 20.625 20.8446 20.625 20.0667V18.6C20.9897 18.6 21.3394 18.4455 21.5973 18.1704C21.8551 17.8954 22 17.5223 22 17.1333V14.2C22 13.811 21.8551 13.438 21.5973 13.1629C21.3394 12.8879 20.9897 12.7334 20.625 12.7334V12C20.625 10.2496 19.9731 8.57086 18.8127 7.33312C17.6523 6.09538 16.0785 5.40003 14.4375 5.40003H11.6875V3.73683ZM19.25 12V20.0667C19.25 20.4557 19.1051 20.8287 18.8473 21.1038C18.5894 21.3788 18.2397 21.5333 17.875 21.5333H4.125C3.76033 21.5333 3.41059 21.3788 3.15273 21.1038C2.89487 20.8287 2.75 20.4557 2.75 20.0667V12C2.75 10.6386 3.25703 9.3329 4.15955 8.37021C5.06207 7.40753 6.28615 6.86669 7.5625 6.86669H14.4375C15.7139 6.86669 16.9379 7.40753 17.8405 8.37021C18.743 9.3329 19.25 10.6386 19.25 12Z"
          fill="currentColor"
        />
      </g>
    </svg>
    ...
    <div className="bg-white h-screen w-[240px] flex flex-col relative border-r border-[#E0E0E0]">
      ...
      <div className="h-[77px] flex items-center px-[35px]">
        <div className="flex items-center gap-[8px]">
          ...
          />
          <p className="font-poppins font-light text-[11px] text-[#adadad]">
            All Rights Reserved
          </p>
        </div>
      </div>
